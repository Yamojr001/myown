    ...
    return (
        <GuestLayout>
            ...
            <div className="prose prose-sm sm:prose max-w-none text-brand-dark">
                ...
                <h2 className="text-brand-orange mt-6 font-bold">1. Agreement to Terms</h2>
                <p>
                ...
                <h2 className="text-brand-orange mt-6 font-bold">2. Intellectual Property</h2>
                <p>
                ...
                <h2 className="text-brand-orange mt-6 font-bold">3. User Accounts</h2>
                <p>
                ...
                <h2 className="text-brand-orange mt-6 font-bold">4. Acceptable Use</h2>
                <p>
                ...
                <h2 className="text-brand-orange mt-6 font-bold">5. Limitation of Liability</h2>
                <p>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex justify-center">
                <a href={route('register')} className="text-brand-orange font-bold hover:underline">Return to registration</a>
            </div>
        </GuestLayout>
    );
}
