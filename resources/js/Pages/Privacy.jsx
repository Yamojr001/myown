    ...
    return (
        <GuestLayout>
            ...
            <div className="prose prose-sm sm:prose max-w-none text-brand-dark">
                ...
                <h2 className="text-brand-orange mt-6 font-bold">1. Information We Collect</h2>
                <p>
                ...
                <h2 className="text-brand-orange mt-6 font-bold">2. Uploaded Course Materials</h2>
                <p>
                ...
                <h2 className="text-brand-orange mt-6 font-bold">3. How We Use Your Information</h2>
                <p>
                ...
                <h2 className="text-brand-orange mt-6 font-bold">4. Security of Your Information</h2>
                <p>
